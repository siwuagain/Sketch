// sketchpad starts with 50 x 50 grid and color-picker mode
window.onload = () => {
...
//information guide on using grid size slider
...
//sets the board to chosen grid size
...
//code for eraser slider that erases columns from left to right as the user adjusts the slider
...
//code for coloring mode buttons
...
//code for displaying which color mode is currently being used and visually turning it off when another is pressed
...
//code that allows to draw in the cells of the sketchpad
...
//code allowing colors to be lightened or darkened
